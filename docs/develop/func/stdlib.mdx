...
The names and the types are mostly self-explaining. See [polymorphism with forall](/develop/func/functions#polymorphism-with-forall) for more info on the polymorphic functions.
